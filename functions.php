		...
		'fields' => array(
			...
			array(
				...
				'options' => array(
					...
					'mobilization of people'  =>  'mobilization of people',
					'project management'  =>  'project management',
					'recycling'  =>  'recycling',
					'risks'  =>  'risks',
					'school education'  =>  'school education',
					'solidarity economy'  =>  'solidarity economy',
					'technical waste picker training'  =>  'technical waste picker training',
					'training centre for waste pickers'  =>  'training centre for waste pickers',
	...
	$meta_boxes[] = array(
		...
		'fields' => array(
			array(
				...
				'type' => 'multicheck',
				'options' => array(
					'access to cooperative scrap stores' => 'access to cooperative scrap stores',
					...
					'access to psycologists' => 'access to psycologists',
					'access to recyclable materials' => 'access to recyclable materials',
					...
					'child feeding programme' => 'child feeding programme',
					'child school enrollment programme' => 'child school enrollment programme',
					'clean and healthy environment' => 'clean and healthy environment',
					'credit facility programme' => 'credit facility programme',
					'education' => 'education',
					'emergency health care members fund' => 'emergency health care members fund',
					'enterprise development' => 'enterprise development',
					'funeral benefit' => 'funeral benefit',
					'funeral support' => 'funeral support',
					...
					'negotiate waste picker demands' => 'negotiate waste picker demands',
					'occupational health & safety' => 'occupational health & safety',
					'pension fund' => 'pension fund',
					'profit share' => 'profit share',
					'profit share' => 'profit share',
					'provision of safety equipment' => 'provision of safety equipment',
					...
					'small business schemes' => 'small business schemes',
					'social services' => 'social services',
					'socio-economic assistance' => 'socio-economic assistance',
					'solidarity' => 'solidarity',
					'source of income' => 'source of income',
					'textbooks for children' => 'textbooks for children',
					'trade facilitation centre' => 'trade facilitation centre',
					'urban environment management support' => 'urban environment management support',
					'wedding support' => 'wedding support',
					'work skills training' => 'work skills training',
				),
			),
			array(
	...
	$meta_boxes[] = array(
		...
		'fields' => array(
			...
			array(
				...
				'type' => 'multicheck',
				'options' => array(
					'all non metallic waste' => 'all non metallic waste',
