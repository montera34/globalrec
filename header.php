			...
			<div id="tagline" class="col-xs-12 col-md-7 col-lg-8">
				...
				<div class="row">
					<div class="col-xs-12 col-md-8">
						<small>
							<?php _e("The International Alliance of Waste Pickers is a union of waste picker groups representing more than 460,000 workers across 34 countries.",'globalrec'); ?>
						</small>
					</div>
					<div class="col-md-4">
